...
const ReportDetails: React.FC<ReportDetailsProps> = ({ onBack, reportId }) => {
      ...
      <div className="max-w-10/12 mx-auto px-0 py-6 sm:px-6 lg:px-8">
        <div className="flex justify-start items-center">
          <Link href={"/report-history"}>
            <button className="p-2 hover:bg-primary/10 rounded-lg transition-colors duration-200 cursor-pointer">
              <LuArrowLeft size={20} />
            </button>
          </Link>
